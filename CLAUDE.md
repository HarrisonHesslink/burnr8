...
- **v30 mutate pattern**: All mutate calls must use request objects: `service.mutate_X(request=client.get_type("MutateXRequest")(customer_id=..., operations=..., validate_only=...))`. Direct kwargs were removed in SDK v30.
